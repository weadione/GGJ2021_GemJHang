...
//        Hpbar = hpBar.transform.
    ...
    public void PlayerHPbar(){
        ...
        transform.GetChild(1).GetComponent<Text>().text = string.Format("Player HP "+ PHP +"/" + PHPMAX);
        transform.GetChild(2).GetChild(0).GetComponent<Image>().fillAmount = HHP/HHPMAX;
        transform.GetChild(2).GetChild(1).GetComponent<Text>().text = string.Format("Head HP "+ HHP +"/" + HHPMAX);
    }
}
